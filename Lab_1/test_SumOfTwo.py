...
class Tests(unittest.TestCase):
    ...
    # Проверка на работоспособность с отрицательными числами
    def test_NegativeValue(self):
        self.assertEqual(sum_two([2,5,1,-3], 2),[1,3])
        
    # Проверка на работоспособность с одинаковыми значениями в списке
    def test_SameValues(self):
        self.assertEqual(sum_two([4,4,4,4], 8),[0,1])
        
    # Стандартная проверка, на соответствие ожидаемого вывода с реальным
    def test_Equal(self):
        self.assertEqual(sum_two([2,7,11,15], 9),[0,1])
        
    # Тест на случай возможного отсутствия target в списке
    def test_Is_In(self):
